...
import { Package, Warehouse, Ruler, FolderTree } from 'lucide-react'
...
export const InventoryMadal: React.FC = () => {
    ...
    const handleNavClick = (item: typeof sidebarItems[0]) => {
        ...
        navigate(`/master-data/inventory/${item.path}`, {
            ...
            <div className="w-56 shrink-0">
                <div className="h-full rounded-2xl bg-white border border-slate-200 shadow-sm p-3 flex flex-col">
                    <div className="px-3 pt-2 pb-4">
                        ...
                        <p className="text-xs text-slate-400 mt-0.5">Products & warehouse management</p>
                    </div>
                    ...
                    <div className="mt-auto pt-3 border-t border-slate-100 px-3 pb-1">
                        <p className="text-[10px] text-slate-300 text-center">MRP Inventory Module</p>
                    </div>
                </div>
            </div>
                ...
                <div className="h-full rounded-2xl bg-white border border-slate-200 shadow-sm p-6 overflow-y-auto">
                    {state?.backgroundLocation ? (
                        ...
                        <div className="h-full flex flex-col items-center justify-center text-center">
                            ...
                            <p className="text-sm text-slate-400 mt-1 max-w-xs">Choose an option from the sidebar to manage inventory data</p>
                        </div>
                    )}
                </div>
            </div>
